...
<div class="w3-top flex-container">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-medium">
    ...
    <a href="../templates/signin.php" class="w3-bar-item w3-button w3-hover-white">Sign in</a>
    <a href="../templates/login.php" class="w3-bar-item w3-button w3-hover-white">Login</a>
